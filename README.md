...
I'm using OpenWeatherApp APIs to fetch current weather condition in json format. After that all the data is populated in their respective fields using React state.
